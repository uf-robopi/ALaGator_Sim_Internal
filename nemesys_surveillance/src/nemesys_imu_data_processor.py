...
class ImuDataProcessorNode:
    def __init__(self):
        rospy.init_node('nemesys_imu_data_processor')

        self.imu_subscriber = rospy.Subscriber("/nemesys/raw_imu_data", Imu, self.imu_callback)
        self.angle_axis_pubisher = rospy.Publisher("/nemesys/euler_angles", Vector3, queue_size = 1)
